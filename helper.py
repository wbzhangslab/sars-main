...
class Helper:
    ...
    @staticmethod
    def model_global_norm(update_param):
        squared_sum = 0
        for name, layer in update_param.items():
    ...
    def average_shrink_models(self, weight_accumulator, target_model, no_models):
        ...
        for name, data in target_model.state_dict().items():
            ...
            update_per_layer = weight_accumulator[name] * (self.params["eta"] / no_models)
